...
namespace GLaDOSV3.Module.Default
{
    public class ModuleInfo : IGladosModule
    {
        ...
        public Type[] Services(DiscordShardedClient discord, CommandService commands, BotSettingsHelper<string> config, IServiceCollection provider) => new Type[] { typeof(InfoModule), typeof(WelcomeService) };
    }
}
